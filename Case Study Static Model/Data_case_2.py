...
if includeCCS:
    PSet = ["SMR", "CG", "BG", "WE", "SMR-CCS", "CG-CCS", "BG-CCS", "WE-CCS"]  # added 4 new plant options, including CCS
else:
    PSet = ["SMR", "CG", "BG", "WE"]  # no CCS
...
if includeCCS:
    ...
    A_CCS_p[4] = A_CCS_p[5] = A_CCS_p[6] = A_CCS_p[7] = 1
...
CO2Prod_pi[(3, 1)] = 24.5
if includeCCS:
    # with CCS (corrections are done in the model):
    CO2Prod_pi[(4, 0)] = 10.8
    CO2Prod_pi[(4, 1)] = 14.6
    CO2Prod_pi[(5, 0)] = 23.8
    CO2Prod_pi[(5, 1)] = 26.6
